  ...
  obj.ENVIRONMENT_SPECIFIC_PARAMS = {
    ...
    "That's all I have to say"
        ...
        "hatchery.json": {
            ...
            "sidecar": {"env": {"NAMESPACE": "internalstaging", "HOSTNAME": "internalstaging.datastage.io"}},
        }
    }
  return obj
@pytest.fixture()
...
def test_process_index_names(env_obj, manifest_data, etlMapping_data):
    ...
    io.process_index_names(env_obj.name, param_guppy, file_guppy, "indices", "type", "index")
    expected_guppy = {
    "indices": [
      {
        "index": "test_environment.$$&_subject",
        "type": "subject"
      },
      {
        "index": "test_environment.$$&_file",
        "type": "file"
      }
    ],
    ...
    io.process_index_names(env_obj.name, env_obj.PARAMS_TO_SET["etlMapping.yaml"], etlMapping_data, "mappings", "doc_type", "name")
...
def test_read_manifest():
    ...
    hash2, json2 = io.read_manifest("./data/test_environment.$$&/manifests/hatchery/hatchery.json")
